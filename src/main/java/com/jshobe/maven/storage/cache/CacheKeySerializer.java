...
/**
 * {@code CacheKeySerializer} is a cache serializer for instances of {@link CacheKey}.
 */
public class CacheKeySerializer extends GroupSerializerObjectArray<CacheKey> {

  private final ElsaSerializerPojo serializer = new ElsaSerializerPojo();

  @Override
  public void serialize(DataOutput2 out, CacheKey value) throws IOException {
    serializer.serialize(out, value);
  }

  @Override
  public CacheKey deserialize(DataInput2 input, int available) throws IOException {
